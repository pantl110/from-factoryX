...
const useGetEquipment = () => {
  const [equipmentList, setEquipmentList] = useState<EquipmentListResponseModel | null>(null)
  ...
  return {
    ...
    searchKeyword,
    setSearchKeyword,
    refetch: () => (searchKeyword ? searchAllFields(searchKeyword) : getEquipmentList()),
  }
}
