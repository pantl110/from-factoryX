...
const UnlinkedTableItem = ({
  ...
  return (
    <div className="flex items-center h-14 border-b border-lg Me_Body-3">
      ...
      <p
        className="flex-[1.3] px-3 text-dg Me_Body-3 truncate"
        title={item.material_name}
      >
        {item.material_name}
      </p>
      <p
        className="flex-[0.5] px-3 text-dg Me_Body-3 truncate"
        title={item.material_spec}
      >
        {item.material_spec}
      </p>
      <p
        className="flex-[0.7] px-3 text-dg Me_Body-3 truncate"
      ...
      <p
        className="flex-[0.9] px-3 text-dg Me_Body-3 truncate"
