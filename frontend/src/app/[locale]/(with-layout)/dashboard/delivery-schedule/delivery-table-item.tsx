...
const DeliveryTableItem = ({
  ...
  return (
    <div
      onClick={onClick}
      className="group flex w-full h-15 items-center Me_Body-3 text-dg border-b border-lg cursor-pointer hover:bg-bg transition-colors ease-in-out duration-200"
    >
