...
const ClaimReceiptTaxModal = ({ onClose, issueType }: ClaimReceiptTaxModalProps) => {
  ...
  return (
    <>
      <Modal title={getTitle()} subtitle={getSubtitle()} onClose={onClose} sm={true}>
        <div className="flex justify-end gap-[5px] mt-4">
          <MiniBtn text="취소" textColor="text-sv" hoverColor="" onClick={onClose} />
          <MiniBtn
            text="확인"
            textColor="text-wh"
            bgColor="bg-primary"
