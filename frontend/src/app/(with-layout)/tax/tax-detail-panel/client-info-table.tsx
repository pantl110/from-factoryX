import ClientInfoItem from "./client-info-item";
    ...
    <div className="mb-11">
      ...
      <div className="flex flex-col items-center">
        <div className="flex w-full border-t border-b border-lg">
          <ClientInfoItem label="거래처명" value="플라스틱이 좋아" />
          <ClientInfoItem label="사업자등록번호" value="123-45-67890" />
        </div>
        <div className="flex w-full border-b border-lg">
          <ClientInfoItem label="대표자명" value="홍길동" />
          <ClientInfoItem label="담당자 이메일" value="company@mail.com" />
        </div>
        <div className="flex w-full border-b border-lg">
          <ClientInfoItem label="담당자 연락처" value="010-1234-5678" />
          <ClientInfoItem label="팩스번호" value="02-123-4567" />
        </div>
        <div className="flex w-full border-b border-lg">
          <ClientInfoItem label="업태" value="제조업" />
          <ClientInfoItem label="종목" value="사출성형" />
        </div>
        <div className="flex w-full border-b border-lg">
          <ClientInfoItem
            label="사업장 주소"
        ...
        <div className="flex w-full border-b border-lg">
          <ClientInfoItem label="거래일자" value="2025-06-11" />
          <ClientInfoItem
            label="문서 상태"
            value={
              <Chip
