...
const Facility = ({
  ...
  const [selectedFacility, setSelectedFacility] = useState<FacilityDataModel | null>(null)
  ...
  return (
    <>
      ...
      {/* 설비 생성 판넬 (빈 데이터) */}
      {isCreatePanelOpen && (
        <FacilityDetailPanel facility={emptyFacility} onClose={handleCreatePanelClose} />
      )}
    </>
  )
}
