...
const StockLocationUploadModal = ({ onClose }: StockLocationUploadModalProps) => {
  ...
  const title = hasFiles ? '업로드된 파일을 확인해 주세요.' : '품목 창고 사진을 업로드해 주세요.'
  ...
  return (
    <Modal title={title} subtitle={subtitle} onClose={onClose} width="w-[600px]">
      <div className="mt-3">
        <DropzoneArea
          onClose={onClose}
