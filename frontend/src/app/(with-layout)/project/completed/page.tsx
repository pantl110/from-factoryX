...
const CompletedProjectPage = () => {
  const [selectedStatus, setSelectedStatus] = useState<'전체' | CompletedProjectStatusType>('전체')
  ...
  const { checkedCount, isChecked, toggleAll, toggleOne, setAllChecked, getDeleteButtonText } =
  ...
  return (
    <>
      <div className="flex flex-col gap-8">
        <MainTitleSec selectedStatus={selectedStatus} onStatusChange={handleStatusChange} />
        <div className="px-10 pb-10">
          ...
          />
          <div>
            <TableHeader checkedCount={checkedCount} onToggleAll={toggleAll} onSort={handleSort} />
