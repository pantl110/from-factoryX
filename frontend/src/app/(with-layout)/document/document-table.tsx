...
const DocumentTable = ({
  ...
  const [taxSortField, setTaxSortField] = useState<'writtenDate' | 'date'>('date')
  ...
  const sortedTaxData = [...data].sort((a, b) => {
    const fieldA = taxSortField === 'writtenDate' ? a.writtenDate || '' : a.date
    const fieldB = taxSortField === 'writtenDate' ? b.writtenDate || '' : b.date
