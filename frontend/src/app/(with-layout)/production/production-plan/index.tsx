...
const ProductionPlan = () => {
  ...
  const [operationStatusDropdownRowId, setOperationStatusDropdownRowId] = useState<number | null>(
    null
  )
  ...
  const [facilityDropdownRowId, setFacilityDropdownRowId] = useState<number | null>(null)
        ...
        <div className="w-full overflow-x-auto">
          ...
          {productionPlanData.map((item) => (
            <TableItem
              key={item.id}
              item={item}
              onOperationStatusClick={(e) => handleOperationStatusClick(e, item.id)}
