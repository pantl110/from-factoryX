...
const AgreeArea = ({ watchedValues, setValue }: AgreeAreaProps) => {
  ...
  const handleTogglePrivacy = () => {
    setValue('privacy_policy_agreement', !watchedValues.privacy_policy_agreement)
  }
  ...
  return (
    <div className="flex flex-col gap-2 mt-5 w-100">
      ...
      <div className="flex justify-between">
        <div className="flex gap-2">
          <Checkbox isChecked={watchedValues.terms_of_service} onToggle={handleToggleService} />
      ...
      <div className="flex gap-2">
        <Checkbox isChecked={watchedValues.marketing_agreement} onToggle={handleToggleMarketing} />
