...
const OnboardingPage = () => {
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case 'first-step':
        return <FirstStep onNextStep={handleNextStep} onPrevStep={handlePrevStep} />
      case 'second-step':
        return <SecondStep onNextStep={handleNextStep} onPrevStep={handlePrevStep} />
      case 'third-step':
        return <ThirdStep onNextStep={handleNextStep} onPrevStep={handlePrevStep} />
      default:
        return <Welcome onNextStep={handleNextStep} />
    }
  }
