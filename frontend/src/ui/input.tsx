  ...
  (
    ...
    const getInputClassName = () => {
      ...
      if (disabled) {
        ...
        className += ' border-red hover:border-primary focus:border-primary focus:text-bl'
      } else {
        className += ' border-[#e4e4e7] hover:border-primary focus:border-primary focus:text-bl'
      }
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <div className="relative">
          <input
            ref={ref || inputRef}
            name={name}
            type={isShowPasswordToggle ? (isShowPassword ? 'text' : 'password') : type}
            value={value}
