...
class ProjectLogAPITestCase(TestCase):
    ...
    def test_create_project_log_success(self):
        ...
        data = response.json()
        # print(
        #     "🐍 File: tests/test_api_project_log.py | Line: 84 | test_create_project_log_success ~ data",
        #     data,
        # )
        ...
        self.assertEqual(log.type, "memo")
    ...
    def test_update_project_log_success(self):
        ...
        log = ProjectLog.objects.create(
            project=self.project, type="메모", title="원본 제목", content="원본 내용"
        )
