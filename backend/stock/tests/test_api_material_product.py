...
class MaterialProductAPITestCase(TestCase):
    ...
    def test_get_material_product_connections_product_type(self):
        ...
        # 응답 필드 구조 확인
        first_item = data[0]
        expected_fields = ['connection_id', 'material_id', 'material_name', 'material_code', 'material_spec', 'material_unit', 'quantity']
    ...
    def test_get_material_product_connections_material_type(self):
        ...
        # 응답 필드 구조 확인
        first_item = data[0]
        expected_fields = ['connection_id', 'product_id', 'product_name', 'product_code', 'product_spec', 'product_unit']
        for field in expected_fields:
            self.assertIn(field, first_item)
