...
from factory.schemas.inbound import FactoryEqCreateIn, FactoryEqUpdateIn, FactoryEqFilter
...
async def create_factory_eq(request, payload: FactoryEqCreateIn):
    ...
    return 201, {
        ...
        "created_at": factory_eq.created_at.isoformat() if factory_eq.created_at else None,
        "updated_at": factory_eq.updated_at.isoformat() if factory_eq.updated_at else None,
    }
