...
class FactoryCreateAPITestCase(TestCase):
    ...
    def test_list_factories_without_filter(self):
        ...
        additional_factory = Factory.objects.create(
            name="추가 공장", owner=self.user, business_address="서울시 마포구"
        )
    ...
    def test_list_factories_as_viewer_member(self):
        ...
        other_factory = Factory.objects.create(
            name="다른 공장", owner=other_user, business_address="서울시 서초구"
        )
    ...
    def test_list_factories_owner_and_member(self):
        ...
        # 다른 사용자가 소유한 공장 생성
        other_factory = Factory.objects.create(
            name="다른 사용자 공장", owner=other_user, business_address="서울시 서초구"
        )
    ...
    def test_list_factories_inactive_member_excluded(self):
        ...
        # 다른 사용자가 소유한 공장 생성
        other_factory = Factory.objects.create(
            name="비활성 멤버 공장", owner=other_user, business_address="서울시 마포구"
        )
    ...
    def test_list_factories_multiple_roles(self):
        ...
        factory1 = Factory.objects.create(
            name="관리자 공장", owner=user1, business_address="서울시 강남구"
        )
        factory2 = Factory.objects.create(
            name="운영자 공장", owner=user2, business_address="서울시 서초구"
        )
    ...
    def test_list_factories_empty_result(self):
        ...
        # 다른 사용자가 소유한 공장 생성
        other_factory = Factory.objects.create(
            name="다른 사용자 공장", owner=other_user, business_address="서울시 강남구"
        )
    ...
    def test_list_factories_only_active_members(self):
        ...
        # 다른 사용자가 소유한 공장 생성
        other_factory = Factory.objects.create(
            name="활성 멤버 공장", owner=other_user, business_address="서울시 강남구"
        )
    ...
    def test_list_factories_owner_automatically_included(self):
        ...
        new_factory = Factory.objects.create(
            name="소유자 공장", owner=self.user, business_address="서울시 서초구"
        )
    ...
    def test_list_factories_with_different_roles(self):
        ...
        factory3 = Factory.objects.create(
            name="조회자 공장", owner=user3, business_address="서울시 마포구"
        )
    ...
    def test_list_factories_ordered_by_invited_at_desc(self):
        ...
        # 새로운 공장들 생성
        factory1 = Factory.objects.create(
            name="첫 번째 공장", owner=self.user, business_address="서울시 강남구"
        )

        factory2 = Factory.objects.create(
            name="두 번째 공장", owner=self.user, business_address="서울시 서초구"
        )

        factory3 = Factory.objects.create(
            name="세 번째 공장", owner=self.user, business_address="서울시 마포구"
        )
    ...
    def test_create_factory_and_list_verification(self):
        ...
        list_response = self.client.get(
            list_url, HTTP_AUTHORIZATION=f"Bearer {self.token}"
        )
    ...
    def test_delete_factory_success(self):
        ...
        self.assertFalse(
            FactoryMember.objects.filter(factory_id=self.factory.id).exists()
        )
