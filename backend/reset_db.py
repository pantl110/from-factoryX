import os, sys
import shutil
from cfehome.settings import INSTALLED_APPS
...
custom_apps = [
    ...
    if not app.startswith("django.") and not app.startswith("corsheaders")
]
for app in custom_apps:
    app_name = app.split(".")[-1]
    reset_migrations_list.append(os.path.join(os.path.join(app_name, "migrations")))
