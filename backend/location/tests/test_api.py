...
class LocationAPITestCase(TestCase):
    ...
    def test_list_material_locations(self):
        ...
        location1 = Location.objects.create(
            type="material", location="A-1-1", images=[]
        )
        location2 = Location.objects.create(
            type="material", location="A-1-2", images=["image1.jpg"]
        )
    ...
    def test_list_product_locations(self):
        ...
        location = Location.objects.create(
            type="product", location="B-2-1", images=["image1.jpg"]
        )
    ...
    def test_update_material_location_specific(self):
        ...
        # 위치 2개 생성 및 연결
        location1 = Location.objects.create(
            type="material", location="A-1-1", images=["old1.jpg"]
        )
        location2 = Location.objects.create(
            type="material", location="A-1-2", images=["old2.jpg"]
        )
        self.material.location.add(location1, location2)
        # location2의 정보만 수정 (새로운 API 구조)
        url = f"/v1/location/{location2.id}?factory_id={self.factory.id}"
        data = {"location": "B-2-2", "images": ["new_image.jpg"]}
    ...
    def test_update_location_not_connected(self):
        ...
        location = Location.objects.create(type="material", location="A-1-1", images=[])
    ...
    def test_update_location_direct_by_id(self):
        ...
        # 위치 생성
        location = Location.objects.create(
            type="material", location="A-1-1", images=["old_image.jpg"]
        )

        # 새로운 API 구조로 수정
        url = f"/v1/location/{location.id}?factory_id={self.factory.id}"
        data = {"location": "B-2-2", "images": ["new_image.jpg", "new_image2.jpg"]}
    ...
    def test_update_location_direct_by_id_partial(self):
        ...
        # 위치 생성
        location = Location.objects.create(
            type="product", location="C-3-1", images=["old_image.jpg"]
        )

        # images만 수정
        url = f"/v1/location/{location.id}?factory_id={self.factory.id}"
        data = {"images": ["new_image.jpg"]}
    ...
    def test_delete_location_direct_by_id(self):
        ...
        # 위치 생성
        location = Location.objects.create(
            type="material", location="A-1-1", images=["image.jpg"]
        )
    ...
    def test_update_location_direct_by_id_material_type(self):
        ...
        # material 타입 위치 생성
        location = Location.objects.create(
            type="material", location="Material-A-1", images=[]
        )

        url = f"/v1/location/{location.id}?factory_id={self.factory.id}"
        data = {"location": "Material-B-2", "images": ["material_image.jpg"]}
    ...
    def test_update_location_direct_by_id_product_type(self):
        ...
        # product 타입 위치 생성
        location = Location.objects.create(
            type="product", location="Product-A-1", images=[]
        )

        url = f"/v1/location/{location.id}?factory_id={self.factory.id}"
        data = {"location": "Product-B-2", "images": ["product_image.jpg"]}
