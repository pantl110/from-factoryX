...
from user.schemas.outbound import UserMeOut, SuccessOut, UserRefreshTokenOut, EmailVerificationOut, EmailVerificationCodeOut
from user.schemas.inbound import UserSignupIn, UserLoginIn, RefreshTokenIn, UserUpdateIn, EmailVerificationRequestIn, EmailVerificationCodeIn, PasswordResetIn
...
async def signup(request, data: UserSignupIn):
    ...
    try:
        ...
        raise HttpError(400, "회원가입 중 오류가 발생했습니다. 잠시 후 다시 시도해주세요.")
